...
DermWatch lets users create a local record for a skin spot, add baseline and
follow-up photos, check image quality, and compare measurable visual changes.
